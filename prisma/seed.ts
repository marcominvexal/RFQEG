  ...
  const samples = [
    {
      ...
      lastMileProtection: "Protected", wetSegmentProtection: "N/A",
    ...
    },
    {
      ...
      lastMileProtection: "Unprotected", wetSegmentProtection: "N/A",
    ...
    },
    {
      ...
      lastMileProtection: "Unprotected", wetSegmentProtection: "Protected",
  ...
  for (const s of samples) {
    ...
    const rfq = await prisma.rfq.upsert({
      ...
      create: {
        ...
        lastMileProtection: s.lastMileProtection,
        wetSegmentProtection: s.wetSegmentProtection,
        status: s.status,
