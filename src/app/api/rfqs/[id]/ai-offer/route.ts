    ...
    const context = JSON.stringify(
      {
        rfq: {
          ...
          lastMileProtection: rfq.lastMileProtection, wetSegmentProtection: rfq.wetSegmentProtection,
          remarks: rfq.remarks, specialInstructions: rfq.specialInstructions,
